 ...
 * Command line was: qdbusxml2cpp -c DBusPower -p dbuspower org.lingmo.Power1.xml
 *
...
DBusPower::DBusPower(QObject *parent)
    : QDBusAbstractInterface("org.lingmo.Power1", "/org/lingmo/Power1", staticInterfaceName(), QDBusConnection::sessionBus(), parent)
{
